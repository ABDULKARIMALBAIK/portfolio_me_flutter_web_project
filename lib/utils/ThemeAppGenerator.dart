...
import 'package:portfolio_me/utils/AppColor.dart';

import 'PlatformDetector.dart';
  ...
  ThemeData lightTheme(){
    return ThemeData(
        ...
        scrollbarTheme: ScrollbarThemeData(
          ...
          interactive: true,
          thumbColor: MaterialStateProperty.all(AppColor().primaryColorLight().withOpacity(0.3)),
  ...
  ThemeData darkTheme(){
    return ThemeData(
        ...
        scrollbarTheme: ScrollbarThemeData(
          ...
          interactive: true,
          thickness: MaterialStateProperty.all(12),
          thumbColor: MaterialStateProperty.all(AppColor().primaryColorDark().withOpacity(0.3)),
